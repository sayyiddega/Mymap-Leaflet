      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Lokasi Tanah</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.html">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Lokasi Aset Tanah
                  </li>
                </ol>
              </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">                               
                                <form class="form-horizontal form-user-profile row mt-2" action="tambahaset.php" method="POST" enctype="multipart/form-data">
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="kelurahan" type="text" class="form-control" id="first-name" required="" autofocus="">
									...
									<div class="col-6">
                                        <fieldset class="form-label-group">
											...
											<option>Tenayan Raya</option>
											<option>Payung Sekaki</option>
											<option>Sail</option>
											<option>Limapuluh</option>
											<option>Sukajadi</option>
											<option>Bukit Raya</option>
											<option>Marpoyan Damai</option>
											<option>Tuah Madani</option>
											<option>Binawidya</option>
											<option>Senapelan</option>
											<option>Rumbai</option>
											<option>Rumbai Timur</option>
											<option>Rumbai Barat</option>
											</select>
                                    ...
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="penduduk" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">jumlah penduduk</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="laki" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">jumlah laki-laki</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="perempuan" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">jumlah perempuan</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="luas" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">luas wilayah</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="kepkel" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">kepala keluarga</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="peribadatan" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">sarana peribadatan</label>
                                        </fieldset>
                                    </div>
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="kesehatan" type="text" class="form-control" id="first-name" required="" autofocus="">
									...
									<div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="lat" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">Latitude</label>
                                        </fieldset>
                                    </div>
									<div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="lon" type="text" class="form-control" id="first-name" required="" autofocus="">
                                            <label for="first-name">Longitude</label>
                                        </fieldset>
                                    </div>
									<div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="peta" type="file" class="form-control" id="first-name" autofocus="">
                                            <label for="first-name">SHP</label>
                                        </fieldset>
                                    </div>
									<div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input name="foto" type="file" class="form-control" id="first-name"  autofocus="">
